...
# from here starts the code for the new modules
...
class FuseBlock7(nn.Module):
    def __init__(self, channels):
        ...
        # self.self_fre = Attention(dim=channels)
        # self.self_spa = Attention(dim=channels)
    ...
    def forward(self, fre, spa):
        ...
        # fre = self.self_fre(fre, fre) + fre
        # spa = self.self_spa(spa, spa) + spa
...
class FrequencyBlock(nn.Module):
    def __init__(self, c):
        ...
        self.pipe = nn.Sequential(
            ConvBNReLU2D(c, c, kernel_size=3, padding=1, act='ReLU', norm='Adaptive'),
            FreBlock9(c),
            ConvBNReLU2D(c, c, kernel_size=3, padding=1, act='ReLU', norm='Adaptive')
        )
    def forward(self, x):
...
class SpatialBlock(nn.Module):
    def __init__(self, c):
        ...
        self.pipe = nn.Sequential(
            ConvBNReLU2D(c, c, kernel_size=3, padding=1, act='ReLU', norm='Adaptive'),
            ResidualGroup(c, 3, 4, act='ReLU', n_resblocks=3, norm='Adaptive'),
            ConvBNReLU2D(c, c, kernel_size=3, padding=1, act='ReLU', norm='Adaptive')
        )
...
class AttentionModule(nn.Module):
    def __init__(self, c):
        ...
        self.srb = SpatialBlock(c)
        self.frb = FrequencyBlock(c)
        self.fuse = Fuse(c)
